...
archived_source_path: examples/CUST-900/tickets/2026-08-26_Rocky-Linux-RI-SP-적용문의.md
archived_source_sha256: 2aef1810e1be00bd2f16a83d01872ed0bc1a1bfcf24aee37ea15597e62020b40
---
...
- 고객 프로필: `examples/CUST-900/profile.md`
- 유사 티켓: 없음
...
avoid:
  ...
  - "H1을 확정으로 서술"
commands: on-request
salutation_ref: "examples/CUST-900/profile.md#CONTACT-001"
```
...
- [ ] 함정 문서 참조: `playbooks/pitfalls/ec2-ri-sp-platform-and-marketplace-pricing.md`
...
- 반복 함정으로 `playbooks/pitfalls/ec2-ri-sp-platform-and-marketplace-pricing.md`를 신규 등록함.
