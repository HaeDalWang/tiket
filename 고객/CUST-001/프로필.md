...
| 항목 | 값 | 출처 | 확인일 | 재확인 시점 |
|---|---|---|---|---|
| 문의 대상 계정 | `ACCOUNT-001` | `TICKET-LOCAL-001` | 2026-08-26 | 실제 계정 확인이 필요한 티켓 |
| 문의 대상 OS | Rocky Linux를 사용하는 EC2 인스턴스 일부 | `TICKET-LOCAL-001` | 2026-08-26 | AMI/product code 확인이 필요한 경우 |

## 고객 고유 용어

| 용어 | 의미 | 출처 | 확인일 |
|---|---|---|---|
| 관리 계정 | `ACCOUNT-001` | `TICKET-LOCAL-001` | 2026-08-26 |
...
- 실제 인프라 코드: 미확인
- 고객 제공 자료: Zendesk `TICKET-LOCAL-001`
