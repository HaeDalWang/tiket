...
source_packet: ../CUST-900/티켓/2026-08-26_Rocky-Linux-RI-SP/current.md
source_evidence: ../CUST-900/티켓/2026-08-26_Rocky-Linux-RI-SP/evidence.md
...
기술 근거, 관찰일, certainty와 재검증 조건은 [`evidence.md`](../CUST-900/티켓/2026-08-26_Rocky-Linux-RI-SP/evidence.md)를 따른다. 외부 문서 또는 상품 조건이 바뀌었거나 실제 고객 티켓에 재사용할 때는 원본 evidence를 현재 자료로 다시 검증한다.
